import DocsQuickStartEn from '../content/en/quick-start.mdx';
import DocsQuickStartDe from '../content/de/quick-start.mdx';
...
export default async function DocsQuickStart({
  params,
}: {
